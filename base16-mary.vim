" Base16 mary (https://github.com/chriskempson/base16)
" Scheme: Maria Aufheimer
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-mary.".&background.".sh"
  endif
endif
